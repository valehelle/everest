...
import {hooks as colocatedHooks} from "phoenix-colocated/inventory_reservation"
...
Hooks.CountdownTimer = {
  ...
  destroyed() { clearInterval(this._interval) },
  startTimer() {
    clearInterval(this._interval)
    const expiresAt = parseInt(this.el.dataset.expiresAt)
    const tick = () => {
      ...
      if (remaining <= 0) clearInterval(this._interval)
    }
    tick()
